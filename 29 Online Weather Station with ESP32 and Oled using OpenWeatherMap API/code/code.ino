...
const char* ssid     = "voidloop";                 // SSID of local network
const char* password = "shivam1234";                    // Password on network
String APIKEY = "685e3a1b80d0c3799e9ebece0fe5501c";
String CityID = "1275004";          //Your City ID
bool id = false;
WiFiClient client;
